...
public static void iningresos(){
        ...
        System.out.println("-El mes no debe de ser menor a 1 ni mayor a 12");
        ...
        System.out.println("Considerando esto, dame la cantidad de ingresos que ingresarás:");
        x=sc.nextInt();
        x+=icopia;
        while(i<x) {
    ...
    public static void inegresos(){
        ...
        System.out.println("Considerando esto, dame la cantidad de egresos que ingresarás:");
        x=sc.nextInt();
        x+=jcopia;
        while(j<x) {
            System.out.println("Ingreso No."+contador);
